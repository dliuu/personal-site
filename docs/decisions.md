...
- 2026-09-19: Direction changed from a 3D room to editorial chapters over one fixed canvas (Shopify Editions model, wiki entry 1). Theme is a halftone post pass carried into type and palette. studio-room stays in the lab as the rejected comparison. Added postprocessing + @react-three/postprocessing.
