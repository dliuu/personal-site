...
Build, bake and export the intro room.
    ...
    blender -b --python scripts/room/build.py -- [--samples 256] [--preview] [--blend]
...
M = {
    ...
    "mesh": make_material("mesh", textures="linen", color=(0.07, 0.075, 0.085, 1), scale=6.0, use_diffuse=False),
}
